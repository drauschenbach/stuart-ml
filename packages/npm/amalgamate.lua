...
-- Invoke amalg.lua to produce a single stuart-ml.lua file
os.execute('amalg.lua -s empty.lua -o stuart-ml.lua -c')


-- Produce a stuart-ml-min.lua file
-- TODO
...
file:write('{\n')
file:write('  "name": "lua-stuart-ml",\n')
file:write('  "version": "' .. version .. '",\n')
file:write('  "description": "' .. description.summary .. '",\n')
file:write('  "main": "stuart-ml.lua",\n')
...
os.execute('cp -v package.json stuart-ml.lua package/')
os.execute('tar zcf lua-stuart-ml.tgz package/*')
os.execute('rm -rf package')
